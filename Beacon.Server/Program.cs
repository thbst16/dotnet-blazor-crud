...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        Title = "Beacon API",
        Version = "v1",
        Description = "CRUD API Services that act as the backend to the Beacon website."
    });
...
app.UseSwaggerUI(c => 
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Beacon.api v1");
